...
<body>
    <div class="tab">
        <button class="tablinks btn btn-primary" onclick="openTab(event, 'Users')" id="defaultOpen">Usuarios</button>
        <button class="tablinks btn btn-primary" onclick="openTab(event, 'Departments')">Departamentos</button>
        <button class="btn btn-primary" onclick="openTab(event, 'Categories')">Categorías</button>
                ...
                <div class="modal-body">
                    <form id="addUserForm">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="departmentSelectUser" name="departmentSelectUser" required>
    ...
    <div id="editDeptModal" class="modal fade" tabindex="-1" aria-labelledby="editDeptModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
        ...
        if ($result_cat->num_rows > 0) {
            ...
            while ($row = $result_cat->fetch_assoc()) {
                ...
                if ($row["nombre_categoria"] != "Sin categoría") {
                    ...
                    echo "<td class='button-group'>";
                    echo "<button type='button' class='editCatBtn' style='color: white; font-weight: 600; background-color:#4caf50;' onclick='openEditCatModal(" . $row["id_categoria"] . ")'>EDITAR</button>";
